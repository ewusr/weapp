<%@ Page Title=""  MaintainScrollPositionOnPostBack="true" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Sellpage.aspx.cs" Inherits="WebApplication3.Sellpage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">Name</label>
                        <asp:TextBox class="form-control py-2" type="text" ID="Name" ReadOnly="true" runat="server"></asp:TextBox>
                    
                    </div>
                       </div>
                  <div class="row">
                    <div class="col-md-12 form-group" style="left: 2px; top: 0px">
                      <label for="name">Email Address</label>
                        <asp:TextBox class="form-control py-2"  ID="Email" ReadOnly="true" runat="server"></asp:TextBox>
      ...
      <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">Type</label>
                        <asp:TextBox class="form-control py-2"  ID="type" ReadOnly="true" runat="server"></asp:TextBox>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:desibrandsConnectionString %>" SelectCommand="SELECT * FROM [Products]"></asp:SqlDataSource>
